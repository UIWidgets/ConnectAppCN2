...
namespace ConnectApp.Components {
    public class ArticleCommentCard : StatelessWidget {
        public ArticleCommentCard(
            Message message,
            string userLicense,
            bool isPraised,
                                ...
                                child: new Column(
                                    ...
                                    children: new List<Widget> {
                                        this._buildCommentAvatarName(
                                            UserInfoManager.isMe(userId: this.message.author.id)),
        ...
        Widget _buildCommentContent() {
            ...
            var textSpans = new List<InlineSpan>();
