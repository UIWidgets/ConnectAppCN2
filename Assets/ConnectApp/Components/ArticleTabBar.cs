    ...
    public class ArticleTabBar : StatelessWidget {
        ...
        public override Widget build(BuildContext context) {
            return new Container(
                height: 49,
                padding: EdgeInsets.only(16, right: 6),
                ...
                child: new Row(
                    ...
                    children: new List<Widget> {
                        ...
                        //     child: new Icon(icon: CIcons.comment, size: 24, color: CColors.Icon)
                        // ),
                        // //点赞
                        // new LikeButton.LikeButton(
                        //     isLiked => new Icon(
                        //         isLiked ? CIcons.favorite : CIcons.favorite_border,
                        ...
                        new CustomButton(
                            ...
                            child: new Icon(
                                this.favorite ? CIcons.bookmark : CIcons.outline_collect,
                                size: 24,
                                color: this.favorite ? CColors.PrimaryBlue : CColors.TextBody2
                            )
                        ),
                        //分享
                        new CustomButton(
                            ...
                            child: new Icon(icon: CIcons.outline_share2, size: 24, color: CColors.TextBody2)
                        )
                    }
                )
            );
