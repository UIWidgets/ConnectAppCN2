...
namespace ConnectApp.Components {
    public class CoverImage : StatelessWidget {
        ...
        public override Widget build(BuildContext context) {
            ...
            var coverImageWidth = MediaQuery.of(context: context).size.width;
            if (this.coverImage.isNotEmpty()) {
                ...
                coverImageWidget = new Container(
                    color: CColors.Black,
                    child: Image.file(
                        "image/default-background-cover.png",
                        height: this.height,
                        width: coverImageWidth,
                        fit: BoxFit.cover
                    )
        ...
        public override Widget build(BuildContext context) {
            ...
            if (this.images.Count > 0) {
                firstImage = new PlaceholderImage(
                    CImageUtils.SizeTo200ImageUrl(this.images[0]),
            ...
            if (this.images.Count > 1) {
                secondImage = this.onlyShowFirst
                    ...
                    : new PlaceholderImage(
                        CImageUtils.SizeTo200ImageUrl(this.images[1]),
            ...
            if (this.images.Count > 2) {
                thirdImage = this.onlyShowFirst
                    ...
                    : new PlaceholderImage(
                        CImageUtils.SizeTo200ImageUrl(this.images[2]),
                        width: this.size,
                        height: this.size,
                        6,
                        fit: BoxFit.cover,
