...
namespace ConnectApp.Components {
    ...
    public class CustomListView : StatelessWidget {
        ...
        public override Widget build(BuildContext context) {
            ...
            var refreshWidget = this._buildRefreshWidget(listView: listView);
            var scrollBarWidget = this._buildScrollBarWidget(widget: refreshWidget);
    ...
    public class SectionView : StatelessWidget {
        ...
        List<IndexPath> indexPaths {
            get {
                ...
                var indexPaths = new List<IndexPath>();
        ...
        public override Widget build(BuildContext context) {
            var itemCount = this.indexPaths.Count;
            if (this._hasHeaderWidget()) {
                itemCount += 1;
            }
        ...
        Widget _itemBuilder(BuildContext context, int index) {
            ...
            var indexPath = indexPaths[index: index];
