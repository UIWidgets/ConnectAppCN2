...
namespace ConnectApp.Components {
        ...
        public static readonly DecorationTween _kGradientShadowTween = new DecorationTween(
            ...
            new _CustomEdgeShadowDecoration(
                new LinearGradient(
                    ...
                    new List<float> {0.0f, 0.3f, 0.6f, 1.0f}
                )
            )
        );
    }
    ...
    public class CustomPageRoute : PageRoute {
        ...
        protected override void didChangePrevious(Route previousRoute) {
            var previousTitleString = previousRoute is CustomPageRoute
                ? ((CustomPageRoute) previousRoute).title
                : null;
            if (this._previousTitle == null) {
                this._previousTitle = new ValueNotifier<string>(value: previousTitleString);
            }
            ...
            base.didChangePrevious(previousRoute: previousRoute);
        }
        ...
        static bool _isPopGestureEnabled(PageRoute route) {
            ...
            if (isPopGestureInProgress(route: route)) {
                return false;
            }
        ...
        public override Widget buildPage(BuildContext context, Animation<float> animation,
            ...
            var result = this.builder(context: context);
        ...
        static _CustomPageRouteBackGestureController _startPopGesture(PageRoute route) {
            D.assert(_isPopGestureEnabled(route: route));
        ...
        Widget buildPageTransitions(
            ...
            return new CustomPageTransition(
                ...
                linearTransition: isPopGestureInProgress(route: route),
                child: new _CustomPageBackGestureDetector(
                    enabledCallback: () => _isPopGestureEnabled(route: route),
                    onStartPopGesture: () => _startPopGesture(route: route),
                    child: child
                )
            );
        }
        ...
        public override Widget buildTransitions(BuildContext context, Animation<float> animation,
            ...
            if (this.overrideTransitionsBuilder != null) {
                return this.overrideTransitionsBuilder(context: context, animation: animation,
                    secondaryAnimation: secondaryAnimation, child: child);
            }

            return this.buildPageTransitions(this, context: context, animation: animation,
                secondaryAnimation: secondaryAnimation, child: child);
        }
    ...
    class _CustomPageBackGestureDetectorState : State<_CustomPageBackGestureDetector> {
        ...
        public override void initState() {
            base.initState();
            this._recognizer = new HorizontalDragGestureRecognizer(this);
        ...
        public override Widget build(BuildContext context) {
            var dragAreaWidth = Directionality.of(context: context) == TextDirection.ltr
    ...
    class _CustomPageRouteBackGestureController {
        ...
        public void dragEnd(float velocity) {
            ...
            if (animateForward) {
                var droppedPageForwardAnimationTime = Mathf.Min(
                    MathUtils.lerpNullableFloat(a: CustomPageRouteUtils._kMaxDroppedSwipePageForwardAnimationTime, 0f,
                ...
                if (this.controller.isAnimating) {
                    int droppedPageBackAnimationTime =
                        MathUtils.lerpNullableFloat(0f,
                            b: CustomPageRouteUtils._kMaxDroppedSwipePageForwardAnimationTime,
                            t: this.controller.value).floor();
            ...
            if (this.controller.isAnimating) {
                ...
                animationStatusCallback = (AnimationStatus status) => {
                    ...
                    this.controller.removeStatusListener(listener: animationStatusCallback);
                };
                this.controller.addStatusListener(listener: animationStatusCallback);
            }
            else {
                this.navigator.didStopUserGesture();
            }
    ...
    class _CustomEdgeShadowDecoration : Decoration, IEquatable<_CustomEdgeShadowDecoration> {
        ...
        static _CustomEdgeShadowDecoration lerpCustom(
            ...
            return new _CustomEdgeShadowDecoration(
                LinearGradient.lerp(a: a?.edgeGradient, b: b?.edgeGradient, t: t)
            );
        }

        public override Decoration lerpFrom(Decoration a, float t) {
            if (!(a is _CustomEdgeShadowDecoration)) {
                return lerpCustom(null, this, t: t);
            }

            return lerpCustom((_CustomEdgeShadowDecoration) a, this, t: t);
        }

        public override Decoration lerpTo(Decoration b, float t) {
            if (!(b is _CustomEdgeShadowDecoration)) {
                return lerpCustom(this, null, t: t);
            }

            return lerpCustom(this, (_CustomEdgeShadowDecoration) b, t: t);
        }

        public override BoxPainter createBoxPainter(VoidCallback onChanged = null) {
            return new _CustomEdgeShadowPainter(this, onChange: onChanged);
        }
        ...
        public bool Equals(_CustomEdgeShadowDecoration other) {
            ...
            return Equals(objA: this.edgeGradient, objB: other.edgeGradient);
        }
        ...
        public override void debugFillProperties(DiagnosticPropertiesBuilder properties) {
            ...
            properties.add(new DiagnosticsProperty<LinearGradient>("edgeGradient", value: this.edgeGradient));
        }
    }
    ...
    class _CustomEdgeShadowPainter : BoxPainter {
        ...
        public override void paint(Canvas canvas, Offset offset, ImageConfiguration configuration) {
            var gradient = this._decoration.edgeGradient;
            if (gradient == null) {
                return;
            }

            var deltaX = -configuration.size.width;
            var rect = (offset & configuration.size).translate(translateX: deltaX, 0.0f);
            var paint = new Paint {
