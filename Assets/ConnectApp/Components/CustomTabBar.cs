...
namespace ConnectApp.Components {
    ...
    public class CustomTabBarState : State<CustomTabBar> {
        ...
        public override void initState() {
            ...
            this._articleRefreshSubId = EventBus.subscribe(sName: EventBusConstant.article_refresh, args => {
                if (args.isNotNullAndEmpty()) {
                    var status = (TabBarItemStatus) args[0];
        ...
        public override Widget build(BuildContext context) {
            if (this._bottomPadding != MediaQuery.of(context: context).padding.bottom &&
                Application.platform != RuntimePlatform.Android) {
                this._bottomPadding = MediaQuery.of(context: context).padding.bottom;
            }
        ...
        Widget _buildBottomTabBar() {
            // TODO: Finn TabBar Blur
            return new Align(
                alignment: Alignment.bottomCenter,
                child: new Container(
                    height: CSizes.TabBarHeight + this._bottomPadding,
                                ...
                                onTap: () => {
                                    if (this._selectedIndex != item.index) {
                                        if (this.widget.tapCallBack != null) {
                                            if (this.widget.tapCallBack(fromIndex: this._selectedIndex,
                                                toIndex: item.index)) {
                                    ...
                                    child: new Column(
                                        ...
                                        children: new List<Widget> {
                                            ...
                                            new Padding(
                                                ...
                                                child: new Text(data: item.title,
                                                    style: new TextStyle(
                                                        fontSize: 10,
        ...
        Widget _buildItemIcon(CustomTabBarItem item) {
            ...
            if (this._tabBarItemStatus == TabBarItemStatus.toRefresh) {
                ...
                for (var index = 0; index <= 60; index++) {
                    loadingImages.Add($"image/tab-loading/home-to-refresh/home-to-refresh{index}.png");
                }
            ...
            if (this._tabBarItemStatus == TabBarItemStatus.toHome) {
                var loadingImages = new List<string>();
                for (var index = 0; index <= 60; index++) {
                    loadingImages.Add($"image/tab-loading/refresh-to-home/refresh-to-home{index}.png");
                }
            ...
            if (this._tabBarItemStatus == TabBarItemStatus.refreshToLeave) {
                return new RotationAnimation(
                    child: new Icon(icon: CIcons.tab_home_refresh_fill, size: item.size, color: item.activeColor),
        ...
        void _onPageChanged(int page) {
            this._pageController.jumpToPage(page: page);
        }
