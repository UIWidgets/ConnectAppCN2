    ...
    public class CustomTabPageSelector : StatelessWidget {
        ...
        Widget _buildTabIndicator(
            ...
            if (tabController.indexIsChanging) {
                var t = 1.0f - CustomTabsUtils._indexChangeProgress(controller: tabController);
        ...
        public override Widget build(BuildContext context) {
            var fixColor = this.color ?? CColors.Transparent;
            var fixSelectedColor = this.selectedColor ?? CColors.PrimaryBlue;
            ...
            var tabController = this.controller;
            D.assert(() => {
            ...
            return new AnimatedBuilder(
                ...
                (subContext, child) => {
                    ...
                    for (var tabIndex = 0; tabIndex < tabController.length; tabIndex++) {
