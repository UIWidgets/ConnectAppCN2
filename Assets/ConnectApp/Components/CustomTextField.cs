...
namespace ConnectApp.Components {
    public class CustomTextField : StatefulWidget {
        public CustomTextField(
            ...
            this.isShowEmojiButton = isShowEmojiButton;
        ...
        public readonly bool isShowEmojiButton;
    ...
    class _CustomTextFieldState : State<CustomTextField> {
        ...
        public override void initState() {
            ...
            this._controller.addListener(listener: this._onTextChanged);
        }

        public override void dispose() {
            base.dispose();
            this._controller.removeListener(listener: this._onTextChanged);
        }
            ...
            return new Container(
                ...
                child: new Row(
                    ...
                    children: new List<Widget> {
                        ...
                        this.widget.isShowEmojiButton ? this._buildShowEmojiBoardButton() : new Container(),
        ...
        Widget _buildTextField() {
            Widget textFieldWidget = new Container(
                ...
                child: new InputField(
                    ...
                    hintStyle: CTextStyle.PRegularBody4.defaultHeight(),
                    ...
                    child: new Center(
                        child: new Text(
                            ...
                            style: this.widget.controller.text.isEmpty()
                                ? CTextStyle.PLargeDisabled.defaultHeight()
                                : CTextStyle.PLargeBlue.defaultHeight()
                        )
                    )
                )
            );
        ...
        Widget _buildShowEmojiBoardButton() {
            return new CustomButton(
                ...
                child: new Container(
                    ...
                    child: new Center(
                        child: new Icon(
                            this.widget.showEmojiBoard ? CIcons.outline_keyboard : CIcons.mood,
                            size: 28,
                            color: CColors.Icon
                        )
                    )
