    ...
    public class FavoriteCard : StatelessWidget {
        ...
        Widget _buildFavoriteIcon() {
            ...
            if (this.favoriteTag.type == "default") {
                ...
                imageName = $"{CImageUtils.FavoriteCoverImagePath}/{this.favoriteTag.iconStyle.name}".addSuffix(".png");
                color = new Color(uint.Parse(s: this.favoriteTag.iconStyle.bgColor));
            }
        ...
        Widget _buildFavoriteInfo() {
            var title = this.favoriteTag.type == "default" ? "默认" : this.favoriteTag.name ?? "";
            return new Expanded(
                child: new Column(
