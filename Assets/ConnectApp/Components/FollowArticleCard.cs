...
namespace ConnectApp.Components {
    public class FollowArticleCard : StatelessWidget {
        ...
        Widget _buildAvatar() {
            ...
            if (this.type == OwnerType.user && this.user.title.isNotEmpty()) {
            ...
            if (this.type == OwnerType.team && this.team.description.isNotEmpty()) {
                titleWidget = new Text(
                    data: this.team.description,
                    style: CTextStyle.PSmallBody4,
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis
                );
                                                    ...
                                                    new Flexible(
                                                        child: new Text(
                                                            this.type == OwnerType.user
                                                                ...
                                                                : this.team.name,
                                                            style: CTextStyle.PRegularBody2.merge(
        ...
        Widget _buildBottom() {
            var articleLikeCount = this.article.appLikeCount > 0 ? this.article.appLikeCount : 0;
                                        ...
                                        child: new Row(
                                            children: new List<Widget> {
                                                new Container(
                                                    ...
                                                    child: new Icon(
                                                        this.isLike ? CIcons.thumb_bold : CIcons.thumb_line,
                                                        size: 24,
                                                ...
                                                new Container(
                                                    ...
                                                    child: new Text(
                                                        CStringUtils.CountToString(count: articleLikeCount,
                                                            "点赞"),
                                                        style: CTextStyle.PRegularBody5
                                                    )
                                                )
                                            }
                                        )
                            ...
                            child: new Container(
                                child: new GestureDetector(
                                    ...
                                    child: new Container(
                                        ...
                                        child: new Row(
                                            children: new List<Widget> {
                                                new Icon(icon: CIcons.comment, size: 24, color: CColors.Icon),
                                                new Container(
                                                    margin: EdgeInsets.only(6),
                                                    child: new Text(
