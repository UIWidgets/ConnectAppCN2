...
namespace ConnectApp.Components {
        ...
        public override TextEditingValue formatEditUpdate(TextEditingValue oldValue, TextEditingValue newValue) {
            ...
            if (this.maxLength != null && this.maxLength > 0 && stringInfo.LengthInTextElements > this.maxLength) {
                ...
                var newSelection = newValue.selection.copyWith(
                    Mathf.Min(a: newValue.selection.start, b: truncated.Length),
                    Mathf.Min(a: newValue.selection.end, b: truncated.Length)
                );
    ...
    class _InputFieldState : AutomaticKeepAliveClientMixin<InputField> {
        ...
        public override void initState() {
            ...
            this._textEditingController.addListener(listener: this._controllerListener);
            this._focusNode.addListener(listener: this._focusNodeListener);
        }

        public override void dispose() {
            this._textEditingController.removeListener(listener: this._controllerListener);
            this._focusNode.removeListener(listener: this._focusNodeListener);
        ...
        void _handleTapDown(TapDownDetails details) {
            this._renderEditable.handleTapDown(details: details);
        }
        ...
        void _handleSelectionChanged(TextSelection selection, SelectionChangedCause cause) {
            if (cause == SelectionChangedCause.longPress) {
                this._editableText?.bringIntoView(position: selection.basePos);
            }
        }
                ...
                child: new Container(
                    ...
                    child: new Column(
                        ...
                        children: new List<Widget> {
                            ...
                            this._buildEditableText(context: context)
                        }
                    )
                )
            );
        ...
        Widget _buildLabelText() {
            ...
            return new Container(
                ...
                child: new Text(data: this.widget.labelText,
        ...
        Widget _buildEditableText(BuildContext context) {
            ...
            if (this.widget.clearButtonMode == InputFieldClearButtonMode.always) {
                clearButton = this._buildClearButton(context: context);
            }
            ...
            var formatters = this.widget.inputFormatters ?? new List<TextInputFormatter>();
            ...
            Widget editableText = new TextSelectionGestureDetector(
                ...
                child: new RepaintBoundary(
                    child: new EditableText(
                        ...
                        cursorOffset: new Offset(-2 / MediaQuery.of(context: context).devicePixelRatio, 0),
            ...
            return new GestureDetector(
                onTap: () => {
                    ...
                    FocusScope.of(context: context).requestFocus(node: focusNode);
                },
                child: new Container(
