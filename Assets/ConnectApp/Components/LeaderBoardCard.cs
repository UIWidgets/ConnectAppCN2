...
namespace ConnectApp.Components {
    ...
    public class LeaderBoardCollectionCard : StatelessWidget {
        ...
        public override Widget build(BuildContext context) {
            ...
            var numColor = this.index + 1 <= 3 ? CColors.Error : CColors.TextBody5;
                        ...
                        children: new List<Widget> {
                            ...
                            new Expanded(
                                child: new Column(
                                    ...
                                    children: new List<Widget> {
                                        new Text(
                                            this.collection.resetTitle.isNotEmpty()
    ...
    public class LeaderBoardColumnCard : StatelessWidget {
        ...
        public override Widget build(BuildContext context) {
            ...
            var images = new List<string>();
            this.userArticle.list.ForEach(article => { images.Add(item: article.thumbnail.url); });
    ...
    public class LeaderBoardBloggerHeader : StatelessWidget {
        ...
        public override Widget build(BuildContext context) {
            ...
            if (this.bloggerIds.Count > 0) {
                ...
                firstAvatar = this._buildAvatar(user: user, "image/blogger-badge1.png", 88, true);
            }
            else {
            ...
            if (this.bloggerIds.Count > 1) {
                ...
                secondAvatar = this._buildAvatar(user: user, "image/blogger-badge2.png");
            }
            else {
            ...
            if (this.bloggerIds.Count > 2) {
                ...
                thirdAvatar = this._buildAvatar(user: user, "image/blogger-badge3.png");
            }
            else {
                        ...
                        new Expanded(
                            ...
                            child: new Column(
                                ...
                                children: new List<Widget> {
                                    ...
                                    Image.file("image/leaderboard-podium-2.png")
                                }
                            )
                        ),
                        new Expanded(
                            ...
                            child: new Column(
                                ...
                                children: new List<Widget> {
                                    ...
                                    Image.file("image/leaderboard-podium-1.png")
                                }
                            )
                        ),
                        new Expanded(
                            ...
                            child: new Column(
                                ...
                                children: new List<Widget> {
                                    ...
                                    Image.file("image/leaderboard-podium-3.png")
                                }
                            )
                        )
                    }
