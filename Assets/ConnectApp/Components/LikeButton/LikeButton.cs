    ...
    public class _LikeButtonState : TickerProviderStateMixin<LikeButton> {
        ...
        public override void didUpdateWidget(StatefulWidget oldWidget) {
            ...
            if (oldWidget is LikeButton likeButton) {
                if (this.widget.isLiked != likeButton.isLiked) {
                    this._handleIsLikeChanged(isLiked: this.widget.isLiked);
                }
            }
        }
        ...
        Widget _buildLikeCountWidget() {
            return !this.widget.showLikeCount
                ...
                : new Container(
                    ...
                    child: new Text(
                        CStringUtils.CountToString(this._likeCount ?? 0, "点赞"),
                ...
                (c, w) => {
                        ...
                        children.Add(
                            new Positioned(
                                ...
                                child: new CustomPaint(
                                    size: new Size(width: this.widget.bubblesSize, height: this.widget.bubblesSize),
                    ...
                    children.Add(
                        new Positioned(
                            ...
                            child: new CustomPaint(
                                size: new Size(width: this.widget.circleSize, height: this.widget.circleSize),
                    ...
                    var likeWidget = this.widget.likeBuilder?.Invoke(isLiked: this._isLiked) ??
                                     LikeButtonUtil.defaultWidgetBuilder(isLiked: this._isLiked,
        ...
        void _onTap() {
            ...
            if (this.widget.onTap != null) {
                ...
                this._handleIsLikeChanged(isLiked: !this._isLiked);
            }
        }
