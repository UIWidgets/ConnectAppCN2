...
using ConnectApp.Components.Markdown.syntax;
...
namespace ConnectApp.Components.Markdown.html {
    public class HtmlView : StatelessWidget {
        public HtmlView(
            ...
            this.customTextStyle = customTextStyle ?? _customTextStyle;
        ...
        static TextStyle _customTextStyle(HtmlNode node, TextStyle baseStyle) {
            var style = new TextStyle();
            if (node.Attributes["color"] != null) {
                style = style.copyWith(
                    color: new Color(ColorsFromName.ColorFromName(name: node.Attributes["color"].Value)));
            }

            return baseStyle.merge(other: style);
        }


        public override Widget build(BuildContext context) {
            var width = this.shrinkToFit ? (float?) null : MediaQuery.of(context: context).size.width;
            ...
            return new Container(
                ...
                child: DefaultTextStyle.merge(
                    style: this.defaultTextStyle ?? DefaultTextStyle.of(context: context).style,
