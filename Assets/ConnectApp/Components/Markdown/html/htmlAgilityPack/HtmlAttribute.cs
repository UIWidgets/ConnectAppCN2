    ...
    public class HtmlAttribute : IComparable {
        ...
        public string Name {
            get {
                if (this._name == null) {
                    this._name =
                        this._ownerdocument.Text.Substring(startIndex: this._namestartindex, length: this._namelength);
                }
        ...
        public string Value {
            get {
                if (this._value == null) {
                    this._value = this._ownerdocument.Text.Substring(startIndex: this._valuestartindex,
                        length: this._valuelength);
                }
        ...
        internal string XmlName {
            get { return HtmlDocument.GetXmlName(name: this.Name); }
        }
        ...
        public string XPath {
            get {
                var basePath = (this.OwnerNode == null) ? "/" : this.OwnerNode.XPath + "/";
        ...
        public int CompareTo(object obj) {
            ...
            return this.Name.CompareTo(strB: att.Name);
        }
        ...
        public HtmlAttribute Clone() {
            var att = new HtmlAttribute(ownerdocument: this._ownerdocument);
            att.Name = this.Name;
        ...
        string GetRelativeXpath() {
            ...
            var i = 1;
            foreach (var node in this.OwnerNode.Attributes) {
