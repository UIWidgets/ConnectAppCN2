...
namespace ConnectApp.Components.Markdown.html.htmlAgilityPack {
    ...
    public class HtmlNodeNavigator : XPathNavigator {
        ...
        public HtmlNodeNavigator(Stream stream, bool detectEncodingFromByteOrderMarks) {
            this._doc.Load(stream: stream, detectEncodingFromByteOrderMarks: detectEncodingFromByteOrderMarks);
            this.Reset();
        }
        ...
        public HtmlNodeNavigator(Stream stream, Encoding encoding) {
            this._doc.Load(stream: stream, encoding: encoding);
            this.Reset();
        }
        ...
        public override string BaseURI {
            get {
                this.InternalTrace(">");
                return this._nametable.GetOrAdd(array: string.Empty);
            }
        }
        ...
        public override string LocalName {
            get {
                if (this._attindex != -1) {
                    this.InternalTrace("att>" + this._currentnode.Attributes[index: this._attindex].Name);
                    return this._nametable.GetOrAdd(array: this._currentnode.Attributes[index: this._attindex].Name);
                }

                this.InternalTrace("node>" + this._currentnode.Name);
                return this._nametable.GetOrAdd(array: this._currentnode.Name);
            }
        }
        ...
        public override string Value {
            get {
                ...
                switch (this._currentnode.NodeType) {
                    ...
                    case HtmlNodeType.Element: {
                        if (this._attindex != -1) {
                            this.InternalTrace(">" + this._currentnode.Attributes[index: this._attindex].Value);
                            return this._currentnode.Attributes[index: this._attindex].Value;
                        }
        ...
        public override string GetAttribute(string localName, string namespaceURI) {
            ...
            var att = this._currentnode.Attributes[name: localName];
            if (att == null) {
                this.InternalTrace(">null");
                return null;
            }
        ...
        public override bool MoveToAttribute(string localName, string namespaceURI) {
            this.InternalTrace("localName=" + localName + ", namespaceURI=" + namespaceURI);
            var index = this._currentnode.Attributes.GetAttributeIndex(name: localName);
            if (index == -1) {
                this.InternalTrace(">false");
                return false;
            }
        ...
        public override bool MoveToId(string id) {
            ...
            var node = this._doc.GetElementbyId(id: id);
            if (node == null) {
                this.InternalTrace(">false");
                return false;
            }
        ...
        internal void InternalTrace(object traceValue) {
            ...
            var name = "";
            var nodename = this._currentnode == null ? "(null)" : this._currentnode.Name;
            string nodevalue;
