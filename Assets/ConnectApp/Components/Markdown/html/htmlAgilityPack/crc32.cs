...
namespace ConnectApp.Components.Markdown.html.htmlAgilityPack {
    ...
    public class Crc32 {
        ...
        static uint[] crc_32_tab = // CRC polynomial 0xedb88320 
        {
        ...
        public static uint CRC32Bytes(byte[] bytes) {
            ...
            for (var i = 0; len > 0; i++) {
                --len;
                oldcrc32 = UPDC32(bytes[len], crc: oldcrc32);
            }
        ...
        public static uint CRC32String(string text) {
            ...
            for (var i = 0; len > 0; i++) {
                --len;
                uCharVal = text[index: len];
                unchecked {
                    lowByte = (byte) (uCharVal & 0x00ff);
                    hiByte = (byte) (uCharVal >> 8);
                }

                oldcrc32 = UPDC32(octet: hiByte, crc: oldcrc32);
                oldcrc32 = UPDC32(octet: lowByte, crc: oldcrc32);
            }
        ...
        internal uint AddToCRC32(ushort c) {
            ...
            hiByte = (byte) (c >> 8);
            this._crc32 = UPDC32(octet: hiByte, crc: this._crc32);
            this._crc32 = UPDC32(octet: lowByte, crc: this._crc32);
            return ~this._crc32;
        }
        ...
        static uint UPDC32(byte octet, uint crc) {
