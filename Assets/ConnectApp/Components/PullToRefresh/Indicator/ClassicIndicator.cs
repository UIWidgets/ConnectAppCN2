...
namespace ConnectApp.Components.PullToRefresh.Indicator {
    ...
    public class ClassicIndicator : IndicatorWidget {
        public ClassicIndicator(
            ...
            this.noMoreIcon = noMoreIcon ?? new Icon(icon: CIcons.close, color: CColors.Grey);
            ...
            this.failedIcon = failedIcon ?? new Icon(icon: CIcons.close, color: CColors.Grey);
            this.height = height;
    ...
    class _ClassicIndicatorState : State<ClassicIndicator> {
        public override Widget build(BuildContext context) {
            var textWidget = this._buildText();
            var iconWidget = this._buildIcon();
            ...
            Widget container = new Row(textDirection: this.widget.iconPos == IconPosition.right
                    ? TextDirection.rtl
                    : TextDirection.ltr,
        ...
        Widget _buildIcon() {
            var icon = this.widget.mode == RefreshStatus.canRefresh
