...
namespace ConnectApp.Components.Swiper {
    public class FractionPaginationBuilder : SwiperPlugin {
        ...
        public override Widget build(BuildContext context, SwiperPluginConfig config) {
            var activeColor = this.activeColor ?? CColors.PrimaryBlue;
            var color = this.color ?? CColors.White;
    ...
    public class RectSwiperPaginationBuilder : SwiperPlugin {
        ...
        public override Widget build(BuildContext context, SwiperPluginConfig config) {
            ...
            var activeIndex = config.activeIndex.Value;
            for (var i = 0; i < itemCount; ++i) {
                var active = i == activeIndex;
                var size = active ? this.activeSize : this.size;
    ...
    public class SwiperPagination : SwiperPlugin {
        public static readonly SwiperPlugin dots = new DotSwiperPaginationBuilder(size: 8, activeSize: 8,
            color: CColors.DarkGray, activeColor: CColors.White);
