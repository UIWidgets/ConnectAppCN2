...
public class PickImageActivity extends TakePhotoActivity {
    ...
    public void takeSuccess(TResult result) {
        ...
        UIWidgetsMessageManager.getInstance().UIWidgetsMethodMessage("pickImage", "pickImageSuccess", Collections.singletonList(new Gson().toJson(map)));
        finish();
    }
            ...
            if (resultCode == RESULT_OK) {
                if (data == null) {
                    ...
                    if (file.length() > 30 * 1024 * 1024) {
                        ...
                        UIWidgetsMessageManager.getInstance().UIWidgetsMethodMessage("pickImage", "pickVideoSuccess", Collections.singletonList(new Gson().toJson(map)));
                    }
                    finish();
    ...
    private void buildAlertDialog(String message) {
        ...
        builder.setNeutralButton("开启", (dialog, which) -> {
