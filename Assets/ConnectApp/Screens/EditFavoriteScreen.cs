                ...
                builder: (context1, viewModel, dispatcher) => {
                    var actionModel = new EditFavoriteScreenActionModel {
                        editFavoriteTag = (tagId, iconStyle, name, description) =>
                            dispatcher.dispatch<Future>(CActions.editFavoriteTag(tagId: tagId, iconStyle: iconStyle,
                                name: name, description: description)),
                        createFavoriteTag = (iconStyle, name, description) =>
                            dispatcher.dispatch<Future>(CActions.createFavoriteTag(iconStyle: iconStyle, name: name,
        ...
        public override void initState() {
            ...
            if (tagId.isNotEmpty()) {
                if (this.widget.viewModel.favoriteTagDict.ContainsKey(key: tagId)) {
                    ...
                    this._favoriteImageName = favoriteTag.iconStyle.name.addSuffix(".png");
                    if (favoriteTag.iconStyle.bgColor.isNotEmpty()) {
                        this._favoriteImageColor = uint.Parse(s: favoriteTag.iconStyle.bgColor);
                    }
                }
            }
        }
                ...
                child: new CustomAlertDialog(
                    ...
                    actions: new List<Widget> {
                        new CustomButton(
                            ...
                            onPressed: () => CustomDialogUtils.hiddenCustomDialog(context: this.context)
                        ),
                        new CustomButton(
                            child: new Text(
                                "确定",
                        ...
                        new CustomButton(
                            ...
                            child: new Text(
                                ...
                                style: disEnabled
                                    ...
                                    : CTextStyle.PLargeMediumBlue.defaultHeight()
                            )
                        )
                    }
                )
