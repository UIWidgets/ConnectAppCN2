        ...
        public override Widget build(BuildContext context) {
            return new StoreConnector<AppState, MyFavoriteScreenViewModel>(
                converter: state => {
                    ...
                    var myFollowFavoriteIds =
                        state.favoriteState.followFavoriteTagIdDict.ContainsKey(key: currentUserId)
                ...
                builder: (context1, viewModel, dispatcher) => {
                    var actionModel = new MyFavoriteScreenActionModel {
                        ...
                        fetchFollowFavorite = offset =>
                            dispatcher.dispatch<Future>(CActions.fetchFollowFavoriteTags(
                    ...
                    () => {
                        ...
                        Navigator.pushNamed(
                            ...
                            new FavoriteDetailScreenArguments {
                                userId = this.widget.viewModel.currentUserId,
