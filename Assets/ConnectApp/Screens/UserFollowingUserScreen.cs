                ...
                builder: (context1, viewModel, dispatcher) => {
                    var actionModel = new UserFollowingScreenActionModel {
                        ...
                        fetchFollowingUser = offset =>
                            dispatcher.dispatch<Future>(CActions.fetchFollowingUser(userId: this.userId,
                                offset: offset)),
                        ...
                        searchFollowingUser = (keyword, pageNumber) => dispatcher.dispatch<Future>(
                            CActions.searchFollowings(keyword: keyword, pageNumber: pageNumber))
                    };
